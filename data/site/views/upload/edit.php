    ...
    <section class="section">
		<div class="eqWrap">
			<div class="eq equalHW">
				...
				<label for="lens"><?php echo $options['lang_lens'] ?></label>
				<input type="text" name="lens" id="lens" value="<?php echo $options['lens'] ?>" /><br />
				...
				<label for="created_at"><?php echo $options['lang_created_at'] ?></label>
				<input type="datetime-local" name="created_at" id="created_at" value="<?php echo $options['created_at'] ?>" /><br />
