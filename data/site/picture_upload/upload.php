...
if (($_FILES['upload'])) {
	...
	} while (file_exists(__DIR__ . "/../" . $path . $pick_file_name));
    chmod($file_temp, 0700);

    $current_file = "../" . $path . $pick_file_name;
	move_uploaded_file($file_temp, $current_file);
    ...
    header('Location: ' . "/index.php?" . $image->getId);
}